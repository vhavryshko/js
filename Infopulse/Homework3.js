...
console.log("1. Write a program that checks whether a number is positive, negative, or zero using the if...else statement");
...
console.log("2. Use a for loop to print the multiplication table for numbers from 1 to 10.");
...
console.log("3. Write a program that uses a while loop to print all even numbers from 1 to 20.");
...
console.log("4. Use a switch statement to print the name of the day of the week based on a number (1 for Monday, 7 for Sunday).");
...
console.log("5. Write a program that uses a do...while loop to calculate the sum of numbers from 1 to 100.");
