...
console.log("First value of initial array is " + getFirstElement(array));
...
console.log("Initial array " + array);
console.log("The sum of initial array is " + sumArray(array));
console.log("-------------------------------------------------");
...
console.log("Reverse array is " + reverseArray(initialArray));
console.log("---------------------------------");
